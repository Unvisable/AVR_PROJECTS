...
#define TIFR_OCF1B             3u /*Output Compare Flag 1 channelB*/
#define TIFR_OCF1A             4u /*Output Compare Flag 1 channelA*/
#define TIFR_ICF1              5u /*Timer1 /Input capture Interrupt Flag*/
